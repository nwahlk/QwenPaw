...
| 文档 | 说明 |
|------|------|
| [项目架构](Architecture.md) | 整体架构设计与模块划分 |
| [安装指南](Installation.md) | 多种安装方式详解 |
| [项目结构](Project-Structure.md) | 目录结构说明 |
| [配置参考](Configuration.md) | 环境变量与配置文件 |
| [API 接口文档](API-Reference.md) | REST API 接口列表 |
| [频道配置](Channels.md) | 各通信频道接入指南 |
| [Skills 系统](Skills.md) | 内置技能与自定义开发 |
| [模型供应商](Model-Providers.md) | 云端与本地模型配置 |
| [安全特性](Security.md) | 多层安全机制详解 |
| [多智能体系统](Multi-Agent.md) | 多 Agent 协作机制 |
| [开发指南](Development.md) | 从源码构建与贡献代码 |
| [CLI 参考](CLI-Reference.md) | 命令行工具完整参考 |
| [常见问题](FAQ.md) | 常见问题与排查 |
| [路线图](Roadmap.md) | 功能规划与开发进度 |
